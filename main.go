...
import (
	...
	/*	"github.com/joho/godotenv" digunakan untuk membaca environment
		"github.com/rs/zerolog/log" digunakan untuk log di command line interface
	*/)
...
// git branch
// git add main.go = untuk menambahkan perubahan
// git config --global user.email "muhamadfarhan1903@gmail.com"
// git config --global user.name "MFRHNHAN"
// git commit -m "github pertama saya" = untuk push
// git push origin main = untuk ngirim dari vscode ke github nya
